...
public class DialogsAlbum {
    ...
    public static AlertDialog createDialogAddAlbum(Context context, AlbumAction action) {
        ...
        EditText name_уе = (EditText) view.findViewById(R.id.add_album_name_ET);
        EditText description_et = (EditText) view.findViewById(R.id.add_album_description_ET);
        Button ok = (Button) view.findViewById(R.id.add_album_ok_btn);
        Button cancel = (Button) view.findViewById(R.id.add_album_cancel_btn);

        name_уе.addTextChangedListener(new TextWatcherEditText() {
            @Override
            public void afterTextChanged(Editable s) {
                if (s.toString().matches(ConstantsManager.REG_EXP_NAME)) {
                    name_уе.setTextColor(context.getResources().getColor(R.color.black));
                    name_уе.setBackground(context.getResources().getDrawable(R.drawable.stroke_field));
                    name_уе.setHint("Имя");
                } else {
                    name_уе.setTextColor(context.getResources().getColor(R.color.error));
                    name_уе.setBackground(context.getResources().getDrawable(R.drawable.et_error_state));
        ...
        ok.setOnClickListener(v -> {
            String name = name_уе.getText().toString();
